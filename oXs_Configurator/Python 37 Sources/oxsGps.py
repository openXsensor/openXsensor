...
ttk.Label(fGps, text="3D speed" ).grid(column= 0, row=1, padx= (15,5), pady=25 , sticky=(E))
ttk.Checkbutton(fGps,  variable=gps3dExist,
	    onvalue='On', offvalue='Off').grid(column=1, row=1, sticky=('W','E') )
ttk.Label(fGps, text="Refresh rate (Hz)").grid(column= 0, row=2, padx= (15,5), pady=5 , sticky=(E))
