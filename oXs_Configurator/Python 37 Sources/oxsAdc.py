from oxsConfig import ttk , W , E , fAdc
...
ttk.Label(fAdc, text="Not yet implemented (so you have to edit manually the config files)" ).grid(column= 0, row=4, padx= 1 , pady= 20)
