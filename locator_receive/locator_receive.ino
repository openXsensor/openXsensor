...
extern uint8_t loraRxPacketRssi ;
extern uint8_t loraRxPacketSnr ;
...
*/  
  ...
  oled.print(latSecDec);
  
  oled.setCursor(0, 2) ; oled.print("dop "); oled.print(oXsGpsPdop);
  oled.setCol( 10) ;  oled.print("gps "); oled.print(oXsLastGpsDelayText[oXsLastGpsDelay]);
  oled.setCursor(0, 3) ; oled.print("oXs Rssi"); oled.print(oXsPacketRssi);
  oled.setCursor(0, 4) ; oled.print("Last gps rec."); oled.print( ( millis() - loraLastPacketReceivedMillis ) /1000); oled.print("s");
  oled.setCursor(0, 5) ; oled.print("Last pack rec."); oled.print( ( millis() - loraLastPacketReceivedMillis ) /1000); oled.print("s");
  oled.setCursor(0, 6) ; oled.print("RSSI="); oled.print(loraRxPacketRssi); oled.print("     ") ;
  oled.setCol( 10) ; oled.print("SNR="); oled.print(loraRxPacketSnr); oled.clearToEOL() ;
*/
/*
}
*/
